...
export const Card = (props) => {
  ...
  return (
    <div className="mt-4 max-w-7xl overflow-hidden rounded-xl bg-gradient-to-b from-white to-darklower shadow-md shadow-darklow dark:shadow-gray-700 dark:bg-gradient-to-b dark:from-darkbg dark:to-darkmid">
